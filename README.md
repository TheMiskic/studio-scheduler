...
The interface is in Serbian (Latin script). All display strings live in `assets/common.js`,
`assets/app.js`, and `assets/admin.js`; day and month names are two arrays near the top of
`common.js`. Commit messages generated by the admin page stay in English.
